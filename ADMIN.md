# Admin Panel Plan (Vue + Express)

Цель: простая админка для редактирования текста, последовательностей сообщений, кнопок и feedback в БД. Доступ — только для админов через Telegram Login. Админка поднимается в Docker на порту `5173`.
