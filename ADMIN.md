...
Цель: админка для редактирования дней, сообщений, feedback и просмотра пользователей. Доступ —
только для админов через Telegram Login. Админка может работать локально или в Docker на порту
`5173`.
